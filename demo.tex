...
\usefolder{styles}
% Use Flux theme v0.2 beta - ECT
% Available style: ect, ufrn, asphalt, blue, red, green, gray
\usetheme[style=ect]{flux}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\date{\today}
\titlegraphic{assets/ECT_horiz.pdf}
%\titlegraphic{assets/UFRN_negativo.pdf}
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
\begin{frame}{Flux}{introduction}
	\justifying
 Flux is a modern style beamer presentation. This is an adaptation for the
 visual identity of ECT--UFRN.  It is provided as a work in progress version
 and may suffer from inconsistencies. Sources and complementary information are
 available at\\[0.3cm]
 \centering{\url{github.com/eltonfc/flux-beamer}}
\end{frame}
...
\begin{frame}[fragile]{Flux}{colors}
	...
	#1 & \cellcolor{primary}\hspace*{1cm} &\cellcolor{primaryLight}\hspace*{1cm}&\cellcolor{secondary}\hspace*{1cm}&\cellcolor{tertiary}\hspace*{1cm}\\
 	\end{tabular}
      	...
      	\definecolor{primaryLight}{cmyk}{1.00,0.60,0.40,0}
      	\definecolor{primary}{cmyk}{.35,0,0,1.0}
      	\definecolor{secondary}{cmyk}{0.28,0,0.85,0.17}
      	\definecolor{tertiary}{cmyk}{0.7,0.30,0.0,0.00}
 	\colorRow{ECT}\\[0.3cm]
      	\definecolor{primaryLight}{HTML}{0095db}
      	\definecolor{primary}{HTML}{164194}
      	\definecolor{secondary}{HTML}{009d43}
      	\definecolor{tertiary}{HTML}{a8563c}
 	\colorRow{UFRN}\\[0.3cm]
...
Give a look at \url{https://github.com/matze/mtheme/tree/master/demo}}
\end{frame}
...
\begin{frame}
 ...
 Flux is licensed under GNU General Public License v3.\\[0.3cm]
 	\centering\url{http://www.gnu.org/licenses}\\[0.3cm]
Inspired by \textbf{Metropolis} theme from Matthias Vogelgesang.\\
\url{https://github.com/matze/mtheme} \\[0.3cm]
Forked from \textbf{Flux} theme from P. Vanberg.\\
